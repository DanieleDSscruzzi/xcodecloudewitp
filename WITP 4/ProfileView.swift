...
struct ProfileView: View {
                    ...
                    VStack(spacing: 14) {
                        ...
                        VStack(spacing: 0) {
                            NavigationLink {
                                ...
                                settingRow(icon: "bubble.left.and.exclamationmark.bubble.right.fill",
                                           title: "Assistenza (WITP Care)", value: "Claude")
                            }
                            ...
                            Divider().padding(.leading, 52)
                            link("Termini d'uso", url: "https://www.whereistheparking.com/support#terms")
                        }
    ...
    private var planCard: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Button {
                // Sempre il paywall: mostra le card per cambiare piano o
                // durata. La pagina Apple "gestisci" (che da abbonati era un
                // vicolo cieco vuoto) resta come link DENTRO il paywall.
                showPaywall = true
            } label: {
                Text(subs.currentTier == .free ? "Scopri Premium e Turbo" : "Cambia piano o durata")
